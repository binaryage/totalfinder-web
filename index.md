...
meta_description: TotalFinder is a plugin to Finder.app which adds tabs, dual-mode feature and enables other tweaks. For example it is possible to have Finder available system-wide activated by a hot-key.
